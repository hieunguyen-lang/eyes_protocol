        ...
        <div className="max-w-md mx-auto">
                ...
                <div className="flex items-start">
                  <div className="flex items-center h-5">
                    <input
                      ...
                      name="terms"
                      type="checkbox"
                      className="h-4 w-4 text-accent1 focus:ring-accent1 border-gray-300 rounded"
                      required
                    />
                  </div>
                  <div className="ml-3 text-sm">
                    <label htmlFor="terms" className="font-medium text-gray-700">
                      I agree to the <a href="#" className="text-accent1 hover:text-accent1/80">Terms of Service</a> and <a href="#" className="text-accent1 hover:text-accent1/80">Privacy Policy</a>
                    </label>
                  </div>
                </div>
                {/* Error Mess */}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="font-medium text-accent1 hover:text-accent1/80">
                Sign in
              </Link>
            </p>
          </div>
